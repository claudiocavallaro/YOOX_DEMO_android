...
public class FragmentHigh extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_high, null);
        communicator = new Communicator();

        Toast.makeText(getContext(), "Perform high request", Toast.LENGTH_SHORT).show();
        communicator.getHighest(this);
    ...
    public void setView() {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_viewH);
